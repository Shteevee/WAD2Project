...
def populate():
	...
	bars = [
		...
		{"name": "The Flying Duck",
		 ...
		 "qual": "1,1,1,1,1",
		 "owner": "Nikola Tesla",
		 "picture": "bar_images/flying_duck",
		...
		{"name": "The Rock",
		 ...
		 "picture": "bar_images/humming_bird",
		 "comments": bar3_comments}
		 ...
		 "qual": "5,5,5,5,5",
		 "owner": "Ronald Graham",
		 "picture": "bar_images/sparkle_horse",
		 "comments": bar4_comments}
		 {"name": "The Lab",
		 "desc": "A third bar.",
